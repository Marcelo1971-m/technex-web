export default function ClubSection() {
  return (
    <section style={{ padding: "60px 40px", textAlign: "center" }}>
      <h2>Historia e identidad Club Technex 10 🚀</h2>
...
<p>
  En esta primera etapa, el equipo estuvo integrado por estudiantes provenientes de
  distintas instituciones educativas de la provincia, conformando un grupo diverso y
  enriquecido por múltiples experiencias formativas. La participación en la Copa
  Robótica de Misiones constituyó una instancia fundacional que permitió conocer el
  funcionamiento de las competencias, el trabajo en equipo y las exigencias técnicas
...
<p>
  ...
  orientada al futuro. En este marco, se encuentra en proceso de organización para su
  conformación como asociación civil sin fines de lucro, con el propósito de fortalecer su
  desarrollo institucional, ampliar sus posibilidades de gestión y garantizar la continuidad
  de sus actividades a largo plazo.
</p>
...
<p style={{ textAlign: "center", fontWeight: "bold", marginTop: "30px" }}>
  “Aprender haciendo, competir creciendo, transformar creando.”
</p>
      </div>
